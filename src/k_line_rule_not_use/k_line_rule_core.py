...
def generate_html():
    ...
    stock_origin_order = [
        # TGV 玻璃通孔
        '京东方A', '沃格光电', '凯盛科技', '五方光电', '兴森科技', '蓝思科技', '帝尔激光', '大族激光', '东威科技', '汇成真空', '德龙激光',
        # 先进封装
        '长电科技', '华天科技', '通富微电', '兴森科技', '深科技', '盛合晶微', '甬矽电子', '晶方科技', '芯原股份', '大港股份', '联瑞新材',
        # 存储芯片
        '兆易创新', '佰维存储', '香农芯创', '德明利', '江波龙', '朗科科技',
        # 玻璃基板
        '京东方A', '鼎龙股份', '中国巨石', '沃格光电', '彩虹股份', '凯盛科技', '帝尔激光', '长信科技', '力诺药包', '红星发展', '金瑞矿业',
        # 光纤
    ...
    stock_tag_map = {}
    tag_blocks = [
        ("TGV 玻璃通孔", ['京东方A', '沃格光电', '凯盛科技', '五方光电', '兴森科技', '蓝思科技', '帝尔激光', '大族激光', '东威科技', '汇成真空', '德龙激光']),
        ("先进封装", ['长电科技', '华天科技', '通富微电', '兴森科技', '深科技', '盛合晶微', '甬矽电子', '晶方科技', '芯原股份', '大港股份', '联瑞新材']),
        ("存储芯片", ['兆易创新', '佰维存储', '香农芯创', '德明利', '江波龙', '朗科科技']),
        ("玻璃基板", ['京东方A', '鼎龙股份', '中国巨石', '沃格光电', '彩虹股份', '凯盛科技', '帝尔激光', '长信科技', '力诺药包', '红星发展', '金瑞矿业']),
