...
def generate_html():
    ...
    stock_origin_order = [
        ...
        # 玻璃基板
        '京东方A', '沃格光电', '凯盛科技', '帝尔激光', '彩虹股份', '长信科技', '力诺药包', '红星发展', '金瑞矿业',
        # 先进封装
        '盛合晶微', '长电科技', '通富微电', '华天科技', '甬矽电子', '晶方科技', '芯原股份', '大港股份', '联瑞新材',
        # 金刚石
    ...
    tag_blocks = [
        ...
        ("玻璃基板", ['京东方A', '沃格光电', '凯盛科技', '帝尔激光', '彩虹股份', '长信科技', '力诺药包', '红星发展', '金瑞矿业']),
        ("先进封装", ['盛合晶微', '长电科技', '通富微电', '华天科技', '甬矽电子', '晶方科技', '芯原股份', '大港股份', '联瑞新材']),
        ("金刚石", ['惠丰钻石', '力量钻石', '四方达', '黄河旋风', '三超新材', '岱勒新材', '国机精工', '楚江新材', '中兵红箭']),
        ("存储芯片", ['兆易创新', '佰维存储', '朗科科技', '德明利', '江波龙']),
        ("铜箔", ['铜冠铜箔', '诺德股份', '嘉元科技', '德福科技']),
        ("PCB", ['鹏鼎控股', '东山精密', '胜宏科技', '深南电路', '沪电股份', '胜宏科技']),
